/**
 * SpeakUP AI - Premium SVG Vector Icon Engine
 * High-precision vector graphics replacing raw emojis for an executive-grade software UI.
 */

const SVGIcons = {
    // 1. AI Spoken Partner - Microchip & Voice Wave
    aiPartner: `
    ...
    // 2. Real Spoken Partner - Dual Network User Nodes
    peerPartner: `
    ...
    // 3. IELTS Band 8.0 - Academic Mortarboard & Scroll
    ieltsPrep: `
    ...
    // 4. Job Viva Prep Studio - Executive Briefcase & Tie
    jobViva: `
    ...
    // 5. Phonetics & Prosody Lab - Sound Spectrum Equalizer
    phonetics: `
    ...
    // 7. Spoken Quizzes & Diagnostic - Academic Shield & Checkmark
    quizEngine: `
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0284C7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    // 8. Vocab Bank - Open Dictionary & Bookmark
    vocabBank: `
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#059669" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    // 9. Personal Space & Community - User Shield Badge
    personalSpace: `
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0284C7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    // 10. Facebook Group Share - Social Share Node
    facebookShare: `
